        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="descripcion" placeholder="Descripción">{{ $marca->descripcion }}</textarea>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    @if ($marca->imagen)
                        <img src="{{ asset('uploads/' . $marca->imagen) }}" alt="Imagen actual" width="100">
                    @else
